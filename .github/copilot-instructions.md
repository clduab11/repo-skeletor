...
- `{{LINEAR_ID}}` — Linear issue identifier (e.g., `PAR-123`)
...
// HACK(username): Temporary workaround until API v2 is ready — PAR-456
```
...
When a developer references a Linear issue (e.g., `PAR-123`), understand that
